...
public class AlertProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://edu.ncsu.apawar2.soc_project1/alerts");
  ...
  static {
    ...
    uriMatcher.addURI("edu.ncsu.apawar2.soc_project1", "alerts", ALERTS);
    uriMatcher.addURI("edu.ncsu.apawar2.soc_project1", "alerts/#", ALERT_ID);
  }
