        ...
        //  @Override
          public void onClick(DialogInterface d, int which) {
            ...
            Toast.makeText(context,
                latitude + ", " + longitude + ": " + input.getText().toString(), Toast.LENGTH_LONG).show();
            ...
            values.put(AlertProvider.KEY_PLACE_LAT,lat );
            values.put(AlertProvider.KEY_PLACE_LNG,lng);        
                        
            Uri uri = context.getContentResolver().insert(AlertProvider.CONTENT_URI,values);
